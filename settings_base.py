...
STATIC_ROOT = os.path.join(PROJDIR, 'staticfiles')
...
MIDDLEWARE_CLASSES = (
    ...
    'auth.middleware.AppengineEntityAuthenticationMiddleware',
...
AUTHENTICATION_BACKENDS = (
    "auth.backends.AppEngineEntityAuthBackend",
)
...
_LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'formatter': 'simple',
            'filename': os.path.join(PROJDIR, 'django.log')
        }
    },
    'loggers': {
        'django': {
